    ...
    <Container maxWidth="2xl" sx={{backgroundImage: "url(https://imageio.forbes.com/specials-images/imageserve/5ffa4ea25f3704b760abea7b/0x0.jpg?format=jpg&height=900&width=1600&fit=bounds)", height:"500px", backgroundSize: "cover",
      ...
      <nav className="z-10 bg-transparent py-5 flex flex-col size-full sm:flex-row sm:items-center sm:justify-between 2xl:px-12 h-20">
        <div className='flex justify-between gap-5 items-center '>
          <div className="flex items-center justify-start gap-2 min-[375px]:gap-4 lg:hidden">
        ...
        <div className={hamburger ? "z-10 flex-col" : "hidden lg:flex lg:flex-row"}>
          <ButtonGroup  aria-label='alignment button group' className={hamburger ? "absolute z-2 w-fit rounded z-2 mt-2 flex flex-col items-start color" : "flex flex-row mt-0 bg-hidden gap-2"}>
            <Button href="#nosotros" variant="contained" color='red' sx={{ color: 'white', border: "none", "&:hover":{textDecoration: "underline wavy",textDecorationThickness: "2px", textUnderlineOffset: "4px", transform:"scale(1.02)", border: "none"}}}>
