      ...
      <Stack spacing={4} direction="column">
        ...
        <Grid container>
          <Grid item md={6} sx={{display: "flex", justifyContent: "center", alignItems: "start"}}>
            <Box sx={{ width: mdScreen ? "100%" : "80%", height: mdScreen ? "100%": 400, position: "relative", display:"flex", alignItems:"center"}}>
                <Stack spacing={4} direction="column" alignItems={mdScreen ? "center" : "start"} sx={{ position: "relative", zIndex: "2"}}>
                  <Typography textAlign={mdScreen ? "center" : "start"} fontFamily="Raleway" fontWeight={700} variant="h3" gutterBottom>
                    "Mucha gente pequeña, en lugares pequeños, haciendo cosas pequeñas, puede cambiar el mundo"
                  </Typography>
                  <Typography variant="underline" textAlign={mdScreen ? "center" : "start"} gutterBottom>
