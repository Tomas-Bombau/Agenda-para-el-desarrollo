...
const NavBar = () => {
  ...
  return (
    <div className={`z-10 py-5 fixed flex flex-col size-full h-20 lg:flex-row lg:items-center lg:justify-between ${scroll ? 'bg-white shadow-md' : 'bg-transparent'}  2xl:px-12`}>
